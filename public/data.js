...
const designCards = [
    {
        ...
        description: '어둠을 렁고 나오는 형광의 대비\n강한 긴장감과 젠은 에너지를 동시에 만듭니다.',
    ...
    },
    {
        ...
        description: '어둠 속에서 피어오르는 붉은 기품\n시선을 한 번에 잊아채면서도 무게감을 잃지 않습니다.',
        colors: [{ name: 'Night', hex: '#000F08' }, { name: 'Imperial', hex: '#FB3640' }],
    },
    {
        id: '04',
        name: 'ICE × MINT',
        category: '카페 / 빌티 / 웰니스 브랜딩',
        description: '스한 우유빛 위에 얹힌 상쿨한 민트\n부드러우면서도 또렇한 인상을 남깁니다.',
    ...
    },
    {
        ...
        description: '부드러운 장밋짓과 차가운 슬레이트의 균형\n감성적이면서도 세련된 인상을 전달합니다.',
